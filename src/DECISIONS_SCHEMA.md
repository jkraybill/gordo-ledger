...
governed_areas:
  - area-tag-1
  - area-tag-2
seal_attestation_id: record-xxx  # Link to Seal ratification record
...
| `seal_attestation_id` | string | Yes | Link to Seal record |
...
- **Seal:** Every entry requires `seal_attestation_id`
